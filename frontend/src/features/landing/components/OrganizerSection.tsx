...
export function OrganizerSection() {
  ...
  return (
    <section className="organizer-gradient-section py-20 lg:py-24">
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-0 z-[1] overflow-hidden opacity-70 [--tile:rgba(110,65,226,0.2)]"
      >
        <Tiles
          rows={34}
          cols={24}
          tileSize="lg"
          className="-translate-x-10 -translate-y-16 justify-start [mask-image:radial-gradient(ellipse_at_center,black_0%,black_54%,transparent_84%)]"
          tileClassName="border-[#C4B5FD]/45 dark:border-[#C4B5FD]/35"
        />
      </div>
              ...
              {column.map((card) => (
                ...
                >
                  ...
                  >
                    ...
                    />
                    <div aria-hidden="true" className="organizer-photo-shine" />
                    <motion.div
