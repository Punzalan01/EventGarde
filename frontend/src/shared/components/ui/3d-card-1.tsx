    ...
    <div className="flex w-full items-center justify-center pt-6">
      ...
      >
        <motion.div style={{ rotateX, rotateY }} transition={springTransition} className="w-full">
          <motion.div
            className="relative h-48 w-full overflow-hidden rounded-2xl bg-gradient-to-br from-emerald-400 to-cyan-400 p-6 shadow-2xl"
          ...
          >
            <div className="flex items-center justify-between">
              <motion.div
                className="flex items-center space-x-2 text-xl font-bold text-white tracking-tight"
            ...
            <motion.div
              className="mt-4 text-xl font-medium tracking-wider text-white"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
